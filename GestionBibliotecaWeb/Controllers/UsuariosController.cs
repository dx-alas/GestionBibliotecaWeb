...
namespace GestionBibliotecaWeb.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(GestionBibliotecaContext context)
        {
            _context = context;
        }
        ...
        {
            var gestionBibliotecaContext = _context.Usuarios.Include(u => u.Rol);
        ...
        public IActionResult Create()
        {
            ViewData["RolId"] = new SelectList(
                _context.Roles.OrderBy(r => r.RolId),
                "RolId",
                "Nombre"
            );
            return View();
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Nombre,Clave,RolId,Activo")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Nombre,Clave,RolId,Activo")] Usuario usuario)
        {
