...
namespace GestionBibliotecaWeb.Controllers
{
    ...
    public class PrestamosAPIController : ControllerBase
    {
        ...
        public PrestamosAPIController(GestionBibliotecaContext context)
        {
            _context = context;
        }

        // GET: api/PrestamosAPI
        [HttpGet]
